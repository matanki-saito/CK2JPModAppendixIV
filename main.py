...
def upload_mod_to_google_drive(upload_file_path,
    ...
    return "{}{}".format("https://drive.google.com/uc?id=", file1['id'])
...
def main():
    ...
    # main name
    mod_file_name = "jpmod_font_aoyagi"
    ...
    mod_pack_file_path = pack_mod(
        ...
        mod_title_name="JPMOD Font: Aoyagi",
    ...
    cdn_url = upload_mod_to_google_drive(
        ...
        name=dt.now().strftime('%Y-%m-%d_%H-%M-%S-{}.zip'.format("ck2-font-aoyagi")),
